				...
				<div class="row">					
					...
					<div class="input-group col-md-12">
						<div class="col-md-12" style="text-align: center;">
							<div class="" id="pictureView" style="border: 1px solid green; height: 200px; width: 140px; margin: 0 auto; margin-bottom:5px;">
							</div>														
...
<script src="<%=request.getContextPath() %>/resources/js/member/modify.js"></script>
