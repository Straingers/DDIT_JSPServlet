		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-outline card-primary">
					...
					<div class="card-body">
						...
						<div class="col-sm-12 row">
							...
							<div class="form-group col-sm-4" >
								...
								<input type="text" class="form-control" id="viewcnt" value="${pds.viewcnt + 1}"
									 readonly />
							</div>	
						</div>	
						<div class="form-group col-sm-12">
					...
					<div class="card-footer">
						<button type="button" id="modifyBtn" class="btn btn-warning" onclick="submit_go('modifyForm.do?pno=${pds.pno}');">Modify</button>						
				    	<button type="button" id="removeBtn" class="btn btn-danger" onclick="submit_go('remove.do?pno=${pds.pno}');">REMOVE</button>
