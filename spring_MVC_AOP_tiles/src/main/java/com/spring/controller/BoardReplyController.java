...
public class BoardReplyController {
	...
	public ResponseEntity<String> register(@RequestBody ReplyRegistCommand regReq) throws Exception {
		ResponseEntity<String> entity = null;
		
		ReplyVO reply = regReq.toReplyVO();
		try {
	...
	public ResponseEntity<String> remobve(@PathVariable("rno") int rno,
