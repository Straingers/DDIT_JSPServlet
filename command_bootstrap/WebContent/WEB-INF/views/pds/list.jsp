					...
					<div class="input-group row">
						<select class="form-control col-md-3" name="perPageNum" id="perPageNum" onchange="list_go();">
							<option value="10" >정렬개수</option>
					  		...
					  		<option value="100" ${pageMaker.cri.perPageNum == 100 ? 'selected':''}>100개씩</option>
						</select>
						<select class="form-control col-md-3" name="searchType" id="searchType">
							...
							<option value="tcw" ${pageMaker.cri.searchType eq 'tcw' ? 'selected':'' }>작성자+제목+내용</option>
						</select>
				...
				<table class="table table-bordered text-center">
					...
					<tr style='font-size:0.85em;'>
							...
							<td id="boardTitle" style="text-align:left;max-width: 100px; overflow: hidden; 
								...
								<a href="javascript:OpenWindow('detail.do?pno=${pds.pno }','상세보기',1000,1100);">
