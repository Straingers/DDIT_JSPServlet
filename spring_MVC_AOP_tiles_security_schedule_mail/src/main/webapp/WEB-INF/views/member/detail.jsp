	        	...
	        	<div class="register-card-body" >
		          ...
		          <div class="card-footer" >
		          		<div class="row">
			          		...
			          		<div class="col-sm-3 text-center">
			          			<button type="button" id="stopBtn" class="btn btn-info" onclick="location.href='stop.do?id=${member.id}'" >정 지</button>
			          		</div>
			          		</c:if>
			          		<c:if test="${member.enabled == 0 }">
			          		<div class="col-sm-3 text-center">
			          			<button type="button" id="stopBtn" class="btn btn-info" onclick="location.href='enabled.do?id=${member.id}'" >활 동</button>
			          		</div>
			          		</c:if>
